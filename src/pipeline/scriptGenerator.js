...
- AGENT THEME (CRITICAL): A key theme of this demo is that the customer is having a unified conversation with an intelligent Agent. The Agent takes action on behalf of the customer and transcends channels — the conversation doesn't end when the customer moves from one channel to another. Multiple specialized agents work together seamlessly behind the scenes (e.g., a commerce agent coordinates with a loyalty agent, an order management agent, a service agent, etc.) to deliver a single, unified experience. Weave this into the narration naturally — for example: "Behind the scenes, ${brandName}'s agent is already working to..." or "The agent seamlessly hands off to..." or "Without missing a beat, the agent remembers her preferences across channels...". EXCEPTION: Scenes that involve Retail Cloud, Auto Cloud, or in-store POS are used by HUMAN employees (store associates, sales consultants) — do NOT describe those as agent-driven. For those scenes, narrate about the employee being empowered with customer data, not an AI agent acting autonomously.
